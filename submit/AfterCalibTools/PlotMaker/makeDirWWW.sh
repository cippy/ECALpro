...
baseDir="AlCaEta_AllRun2017_condor_pi0CC_tuneSel"       # dirname (could use any name, but better to stick with dirname in parameters.py
iter_ini=3 # first iteration to use (in general it would be 0)                                               
iter_fin=3 # last iteration to use: it is included in sequence below (if you did n iterations, this should be n-1)                  
